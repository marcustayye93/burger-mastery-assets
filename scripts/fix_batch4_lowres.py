#!/usr/bin/env python3
"""Replace the two low-resolution Batch 4 assets with full-resolution regenerations."""
import csv
import os
import shutil
...
FIX = '/home/ubuntu/burger_mastery/batch4_fix'

REPLACEMENTS = [
    ('BM-BUN-004-pretzel-bun', 'images/ingredients/buns', False),
    ('BM-CHEESE-018-cheese-comparison-flatlay', 'images/cheese', False),
]
...
# Update manifest dims
mf = os.path.join(REPO, 'metadata', 'batch4_manifest.csv')
with open(mf) as f:
